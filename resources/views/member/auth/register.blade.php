...
<head>
    ...
    <title>Register- GunturSatya</title>

    <link rel="shortcut icon" href="{{ asset('assets/member/compiled/svg/favicon.svg') }}" type="image/x-icon" />
    <link rel="shortcut icon"
        ...
        type="image/png" />
    <link rel="stylesheet" href="{{ asset('assets/member/compiled/css/app.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets/member/compiled/css/app-dark.css') }}" />
    <style>
        #auth {
            min-height: 100vh;
        }
        ...
        <div class="row">
            <div class="atasindikit">
                ...
                <form action="{{ route('actionRegister') }}" method="POST">
                    ...
                    <div class="form-group position-relative has-icon-left mb-4">
                        <input type="text" name="referral_code" id="referral_code" placeholder="Kode Referal" value="" class="form-control form-control-xl">
                        <div class="form-control-icon">
